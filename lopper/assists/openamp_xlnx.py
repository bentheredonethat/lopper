...
def xlnx_openamp_gen_outputs_only(sdt, machine, output_file, verbose = 0 ):
    ...
    try:
        ...
        ipi_irq_vectid = hex(remote_vect_id)
        ipi_irq_vectid_freertos = hex(remote_vect_id - 32)
        if platform == SOC_TYPE.ZYNQMP:
            ipi_irq_vectid_freertos = ipi_irq_vectid
            host_bitmask = None
            for n in tree["/"].subnodes():
        ...
        "IPI_IRQ_VECT_ID": ipi_irq_vectid,
        "IPI_IRQ_VECT_ID_FREERTOS": ipi_irq_vectid_freertos,

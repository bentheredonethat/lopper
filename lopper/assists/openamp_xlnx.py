...
def xlnx_libmetal_gen_output_file(tree, output_file, carveouts, ipi_node, timer_node, os, verbose = 0 ):
    ...
    values = {  "SHM_DEV_NAME": data.name, "SHM_IMAGE_BASE": hex(data["reg"][1]), "SHM_IMAGE_SIZE": hex(data["reg"][3]) }
    values.update({
                "SHM_PAYLOAD_BASE": values["SHM_IMAGE_BASE"], "SHM_PAYLOAD_SIZE": values["SHM_IMAGE_SIZE"],
                "SHM_PAYLOAD_HALF_SIZE": hex(data["reg"][3]//2),
                "SHM_PAYLOAD_RX_OFFSET": 0,
                "SHM_BASE_ADDR": values["SHM_IMAGE_BASE"], "SHM_SIZE": values["SHM_IMAGE_SIZE"],
                "SHM0_DESC_DEV_NAME": desc0.name, "SHM0_DESC_BASE": hex(desc0["reg"][1]), "SHM0_DESC_SIZE": hex(desc0["reg"][3]),
                "SHM1_DESC_DEV_NAME": desc1.name, "SHM1_DESC_BASE": hex(desc1["reg"][1]), "SHM1_DESC_SIZE": hex(desc1["reg"][3]),
